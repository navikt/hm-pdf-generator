...
function App() {
  ...
  const markdown = `
    ...
    Du har rett til å se dokumentene i saken din. Dette følger av forvaltningsloven § 18. Kontakt oss om du vil se dokumentene i saken din. Ta kontakt på [nav.no/kontakt](https://nav.no/kontakt) eller på telefon 55 55 33 33 \\<34\\>. Du kan lese mer om innsynsretten på [nav.no/personvernerklaering](https://nav.no/personvernerklaering).
    ...
    Hvis du ikke finner svar på [nav.no](https://nav.no), kan du ringe oss på telefon 55 55 33 33 \\<34\\> hverdager 09.00-15.00.
