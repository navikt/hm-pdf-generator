...
export const TabSyncPlugin = createPlatePlugin({
  ...
  if (!plugin.options.brevId) {
    ...
    console.log(
      "Ingen brevId satt opp for breveditor, tab-sync ikke aktivert!",
    );
    return ctx;
  }
  ...
  if (import.meta.hot) {
    import.meta.hot.dispose(() => {
      console.log(
        "Component module is being replaced by HMR, closing BroadcastChannel(breveditor-tab-sync-plugin)",
      );
      c.close();
    });
  }
